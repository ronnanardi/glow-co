...
<div class="container py-5">
    ...
    <div class="d-flex align-items-center gap-3 mb-4">
        ...
        <h4 class="fw-bold mb-0">Edit Alamat</h4>
    </div>
        ...
        <div class="card-body p-4">
            ...
            <form method="POST" action="{{ route('addresses.update', $address) }}">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="address" rows="2" class="form-control @error('address') is-invalid @enderror">{{ old('address', $address->address) }}</textarea>
                ...
                <button type="submit" class="btn btn-theme w-100">
                    <i class="bi bi-check-lg me-1"></i> Update Alamat
                </button>
