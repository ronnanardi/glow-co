                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="badge" class="form-select">
                            ...
                            <option value="best" {{ old('badge', $product->badge) == 'best' ? 'selected' : '' }}>Best Seller</option>
                ...
                <div class="mb-4">
                    ...
                    <div class="mt-2">
                        <img id="imagePreview"
                             ...
                             style="{{ $product->image ? '' : 'display:none;' }}width:120px;height:120px;object-fit:cover;border-radius:10px">
                    </div>
                </div>
